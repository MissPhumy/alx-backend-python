...
+ [x] 9. **Let's duck type an iterable object**<br/>[9-element_length.py](9-element_length.py) contains an annotation of the function's (shown below) parameters and return values with the appropriate types.
 ...
 10. Duck typing - first element of a sequence<br/>100-safe_first_element.py contains an augmentation of the following code with the correct duck-typed annotations:
...
def safe_first_element(lst):
    if lst:
        ...
        return None
 11. More involved type annotations<br/>101-safely_get_value.py contains a script that includes the code below with type annotations added to it.
...
def safely_get_value(dct, key, default=None):
    if key in dct:
        ...
        return default
 12. Type Checking<br/>102-type_checking.py contains the code below and uses mypy to validate it and apply any necessary changes.
